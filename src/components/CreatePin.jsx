...
const CreatePin = ({user}) => {
  ...
  return (
    <div className='flex flex-col justify-center items-center mt-5 lg:h-4/5'>
      ...
      <div className='flex lg:flew-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
            ...
            {!imageAsset ? (
              <label>
                ...
                <div className='relative h-full'>
                  <img src={imageAsset?.url} alt="upload-pic" className='w-full h-full' />
                  <button
                    type='button'
